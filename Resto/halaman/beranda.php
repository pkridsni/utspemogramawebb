...
<form action="index.php" method="POST">
    ...
    </div><input class="form-control mx-sm-2 my-2 w-auto" type="text" name="meja" placeholder="No Meja" required autocomplete="off">
       <div class="d-flex"> <select class="form-control mx-sm-2 my-2 w-auto" name="jenis_pesanan" required>
