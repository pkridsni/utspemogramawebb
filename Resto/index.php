...
if (isset($_GET["transaksi"])) {
    ...
    $menu = ambil_data("SELECT p.kode_pesanan, tk.nama_pelanggan, tk.jenis_pesanan, tk.meja, p.kode_menu, p.qty
...
<body class="bg-light">
    ...
    <div id="dropdown-menu" class="container-fluid position-fixed float-start bg-dark text-white w-auto vh-100" style="display: none; z-index: 1; top: 50px;">
        ...
        <ul>
            ...
            <li><a class="text-decoration-none p-2 h5 text-light" href="index.php?pendapatan">PENDAPATAN</a></li>
    ...
    else if (isset($_GET["pendapatan"])) include "halaman/pendapatan.php";
